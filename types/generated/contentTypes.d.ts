...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Article author for E-E-A-T (byline, bio, photo) \u2014 rendered into Article/BlogPosting JSON-LD';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiConfigConfig extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    companyRegistrationDetails: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    footerAddressBlock: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    instagramProfileLink: Schema.Attribute.Component<'shared.link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    internetAcquiring: Schema.Attribute.Enumeration<
      ['webpay', 'bepaid', 'strapi']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    showFooterAddressBlock: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    showInternetAcquiring: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    showPhoneNumber: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    showSubscriptionForm: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearOfEstablishment: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }> &
      Schema.Attribute.DefaultTo<'2002'>;
  };
}
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    configs: Schema.Attribute.Relation<'manyToMany', 'api::config.config'>;
...
export interface ApiRoomTypeRoomType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiUniversalUniversal extends Struct.CollectionTypeSchema {
